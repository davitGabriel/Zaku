        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompanyName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TaxId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ServiceRegions = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "ClientSupplierRelationships",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClientSupplierRelationships", x => x.RelationshipId);
                    table.ForeignKey(
                        name: "FK_ClientSupplierRelationships_Clients_ClientId",
                        column: x => x.ClientId,
                        principalTable: "Clients",
                        principalColumn: "ClientId");
                    table.ForeignKey(
                        name: "FK_ClientSupplierRelationships_Suppliers_SupplierId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Couriers_Suppliers_SupplierId",
                        column: x => x.SupplierId,
                        principalTable: "Suppliers",
                        principalColumn: "SupplierId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProofOfDelivery = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Deliveries", x => x.DeliveryId);
                    table.ForeignKey(
                        name: "FK_Deliveries_DeliverySchedules_ScheduleId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SupplierResponses", x => x.ResponseId);
                    table.ForeignKey(
                        name: "FK_SupplierResponses_ProductRequests_RequestId",
                        column: x => x.RequestId,
                        principalTable: "ProductRequests",
                        principalColumn: "ProductRequestId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SupplierResponses_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClientSupplierRelationships_ClientId",
                table: "ClientSupplierRelationships",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "IX_ClientSupplierRelationships_SupplierId",
                table: "ClientSupplierRelationships",
                column: "SupplierId");

            migrationBuilder.CreateIndex(
                name: "IX_Couriers_SupplierId",
                table: "Couriers",
                column: "SupplierId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SupplierResponses_ProductId",
                table: "SupplierResponses",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_SupplierResponses_RequestId",
                table: "SupplierResponses",
                column: "RequestId");
